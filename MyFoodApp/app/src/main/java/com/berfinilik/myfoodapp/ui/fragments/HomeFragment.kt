...
import com.berfinilik.myfoodapp.adapters.MostPopularRecyclerAdapter
import com.berfinilik.myfoodapp.adapters.OnItemClick
import com.berfinilik.myfoodapp.adapters.OnLongItemClick
...
import com.berfinilik.myfoodapp.mvvm.MainFragMVVM
...
import com.berfinilik.myfoodapp.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        detailMvvm.observeMealBottomSheet().observe(viewLifecycleOwner, Observer { t ->
            t?.let {
